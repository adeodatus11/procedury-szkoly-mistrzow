    ...
    <nav class="topbar" aria-label="Główna nawigacja">
      ...
      <div class="topbar-main">
        <div class="topbar-links">
          ...
          <a href="${prefix}kancelaria.html"${current === "kancelaria" ? ' aria-current="page"' : ""}>Kancelaria</a>
...
function folderChild(name, description) {
  return {
    id: name,
    name,
    title: description,
  ...
  children: [
    {
      ...
      keep: ["Mapa folderow i zasad.", "Lista osob odpowiedzialnych za obszary.", "Instrukcje obiegu dokumentow i wzory opisow."],
    ...
    },
    {
      ...
      keep: ["Zarzadzenia, decyzje, materialy rady pedagogicznej.", "Organizacja roku szkolnego, nadzor pedagogiczny, kontrole i sprawozdania.", "Korespondencja dyrektora wymagajaca decyzji albo nadzoru."],
      naming: ["2026-09-18_DYR_zarzadzenie-nr-12_organizacja-egzaminow_PODPISANE.pdf", "2026-10-03_DYR_protokol-rady-pedagogicznej_RP_PODPISANE.pdf"],
      avoid: ["Nie trzymac tu codziennej korespondencji, ktora obsluguje sekretariat bez decyzji dyrekcji."],
      children: [
        folderChild("Zarzadzenia_i_decyzje", "Podpisane akty dyrektora, decyzje i ich rejestry pomocnicze."),
        folderChild("Rada_Pedagogiczna", "Porzadki obrad, uchwaly, protokoly i materialy na posiedzenia."),
        folderChild("Organizacja_roku_szkolnego", "Arkusz, plany, kalendarze, przydzialy i organizacja pracy."),
        folderChild("Nadzor_pedagogiczny", "Plany nadzoru, obserwacje, wnioski i sprawozdania."),
        folderChild("Kontrole_audyty_sprawozdania", "Kontrole zewnetrzne, audyty, odpowiedzi i zalecenia."),
        folderChild("Korespondencja_dyrektora", "Pisma wymagajace stanowiska albo podpisu dyrektora."),
        folderChild("Robocze_dyrekcja", "Materialy w toku, ktore nie sa jeszcze dokumentem koncowym."),
      ],
    },
    {
      ...
      keep: ["Pisma przychodzace, wychodzace i wytworzone.", "Sprawy do dekretacji, do podpisu, do wyslania.", "Rejestry, ewidencje, umowy i publikacje na strone/BIP."],
      naming: ["2026-09-12_SEKR_pismo-z-UMWroclaw_dotacja_PRZYJETE.pdf", "2026-09-14_SEKR_odpowiedz-do-kuratorium_kontrola_DO_PODPISU.docx"],
      avoid: ["Nie zostawiac spraw w Do_dekretacji dluzej niz kilka dni bez wpisu w ewidencji."],
      children: [
        folderChild("Do_dekretacji", "Tymczasowo: pisma, ktorym dyrektor ma przypisac osobe, termin albo sposob zalatwienia."),
        folderChild("Do_podpisu", "Dokumenty gotowe merytorycznie, oczekujace na podpis."),
        folderChild("Do_wyslania", "Podpisane dokumenty, ktore trzeba wyslac i potwierdzic wysylke."),
        folderChild("Pisma_przychodzace", "Skan PDF, data wplywu, numer i lokalizacja wpisana w ewidencji."),
        folderChild("Pisma_wychodzace_i_wytworzone", "Wersja podpisana PDF oraz ewentualny plik roboczy DOCX."),
        folderChild("Rejestry_i_ewidencje", "Ewidencja dokumentow, rejestry decyzji, pieczeci, upowaznien i spisy pomocnicze."),
        folderChild("Umowy_sprawy_administracyjne", "Umowy, uzgodnienia, sprawy organizacyjne i administracyjne."),
        folderChild("Publikacja_strona_BIP", "Materialy zatwierdzone do publikacji oraz slady publikacji."),
      ],
    },
    {
      ...
      keep: ["Rekrutacja, uczniowie aktywni, absolwenci i uczniowie byli.", "Zaswiadczenia, legitymacje, duplikaty, egzaminy, praktyki.", "Sprawy uczniowskie wymagajace wyjasnienia."],
      naming: ["2026-09-05_UCZ_zaswiadczenie-o-nauce_Nowak-Anna_WYDANE.pdf", "2026-09-20_UCZ_wniosek-o-duplikat-legitymacji_3TP_Kowalski-Jan_PRZYJETE.pdf"],
      avoid: ["Nie trzymac tu dokumentacji PPP, jezeli powinna byc w folderze z ograniczonym dostepem PPP."],
      children: [
        folderChild("Rekrutacja", "Wnioski, listy, korespondencja i rozstrzygniecia dotyczace naboru."),
        folderChild("Uczniowie_aktywne_klasy", "Dokumenty uczniow podzielone rokiem szkolnym i klasa."),
        folderChild("Absolwenci_i_uczniowie_byli", "Sprawy po zakonczeniu nauki, przeniesienia i wydane dokumenty."),
        folderChild("Zaswiadczenia_legitymacje_duplikaty", "Wnioski, wydania i potwierdzenia odbioru."),
        folderChild("Egzaminy_klasyfikacyjne_poprawkowe", "Wnioski, decyzje, harmonogramy, protokoly."),
        folderChild("Praktyki_i_ksztalcenie_zawodowe", "Sprawy uczniowskie zwiazane z praktyczna nauka zawodu."),
        folderChild("Sprawy_do_wyjasnienia", "Tymczasowo: dokumenty wymagajace ustalenia trybu albo brakujacych danych."),
      ],
    },
    {
      id: "ppp",
      ...
      keep: ["Wnioski, opinie, orzeczenia, IPET, WOPFU, dostosowania i notatki zespolu.", "Ustalenia z poradniami i instytucjami.", "Roczne foldery uczniow objetych pomoca."],
      naming: ["2026-09-12_PPP_wniosek_2A_uczen-014_PRZYJETE.pdf", "2026-10-01_PPP_ustalenia-zespolu_2A_uczen-014_PODPISANE.pdf"],
      avoid: ["Nie wpisywac pelnego opisu zdrowia w nazwie pliku.", "Nie udostepniac calego folderu PPP szerokiej grupie nauczycieli."],
      children: [
        folderChild("Procedury_i_wzory", "Wzory wnioskow, kart analizy, notatek i ustalen."),
        folderChild("Uczniowie_objeci_pomoca", "Foldery roczne uczniow, najlepiej z neutralnym identyfikatorem."),
        folderChild("Orzeczenia_opinie_zalecenia", "Skan dokumentow z poradni i zalecen."),
        folderChild("IPET_WOPFU_dostosowania", "Dokumenty tworzone przez zespol oraz zatwierdzone dostosowania."),
        folderChild("Spotkania_zespolu_PPP", "Porzadki, protokoly, ustalenia i listy obecnosci."),
        folderChild("Wspolpraca_z_poradniami_i_instytucjami", "Pisma i notatki ze wspolpracy z podmiotami zewnetrznymi."),
        folderChild("Archiwum_roczne", "Zamkniete roczniki przed przekazaniem zgodnie z instrukcja archiwalna."),
      ],
    },
    {
      id: "wychowawcy",
      ...
      keep: ["Organizacja klasy, zebrania z rodzicami, wycieczki, zgody, klasyfikacja.", "Notatki wychowawcze i interwencje bez kopiowania dokumentow PPP, jezeli wystarczy odniesienie."],
      naming: ["2026-10-03_WYCH_zebranie-z-rodzicami_3TP_PROTOKOL.pdf", "2026-11-15_WYCH_wycieczka-do-muzeum_2A_ZGODY.pdf"],
      avoid: ["Nie robic prywatnych archiwow uczniow poza uzgodnionymi folderami szkoly."],
      children: [folderChild("2026_2027", "Folder rocznika. W srodku zaklada sie foldery klas, np. 1A_Nazwisko_wychowawcy.")],
    },
    {
      ...
      keep: ["Plany pracy, protokoly, wymagania, PZO, analizy wynikow, materialy wspolne.", "Uzgodnienia dotyczace programow, podrecznikow i egzaminow."],
      naming: ["2026-09-09_ZESPOL-HUM_plan-pracy_2026-2027_ROBOCZE.docx", "2026-11-20_ZESPOL-ZAWODOWE_analiza-wynikow_egzamin-zawodowy.pdf"],
      avoid: ["Nie trzymac tu dokumentow pojedynczego ucznia, jezeli sa to sprawy sekretariatu albo PPP."],
      children: [
        folderChild("Humanistyczny", "Jezyk polski, historia, WOS i pokrewne obszary."),
        folderChild("Matematyczno_przyrodniczy", "Matematyka, przedmioty przyrodnicze i analizy wynikow."),
        folderChild("Jezyki_obce", "Przedmioty jezykowe, egzaminy, konkursy i materialy zespolu."),
        folderChild("WF_EDB", "WF, EDB, zwolnienia organizacyjne i dokumenty zespolu."),
        folderChild("Zawodowe", "Ksztalcenie zawodowe, pracownie, egzaminy i uzgodnienia branzowe."),
        folderChild("Inne", "Religia, biblioteka i obszary, ktore nie maja osobnego zespolu."),
      ],
    },
    {
      ...
      keep: ["Ustalenia, harmonogramy, materialy robocze, wersje do publikacji, zamkniecie sprawy.", "Projekty szkolne, zespoly ds. wydarzen, rekrutacji, promocji, egzaminow i ewaluacji."],
      naming: ["2026-09-30_PROJEKT_dzien-otwarty_harmonogram_ROBOCZE.xlsx", "2026-10-15_ZESPOL_promocja_szablon-komunikatu_ZATWIERDZONE.docx"],
      avoid: ["Nie zostawiac projektu bez folderu Zamkniecie_sprawy, gdy dzialania sie skoncza."],
      children: [folderChild("2026_2027", "Rocznik projektow i zespolow. Dla kazdej inicjatywy zaklada sie osobny folder.")],
    },
    {
      id: "szablony",
      ...
      keep: ["Aktualne wzory pism, decyzji, formularzy, procedur, logo, stopki i papier firmowy.", "Archiwalne wersje szablonow oddzielone od aktualnych."],
      naming: ["SZABLON_pismo-ogolne_ZSZ5_AKTUALNY.docx", "SZABLON_decyzja-administracyjna_skreslenie_AKTUALNY.docx"],
      avoid: ["Nie trzymac tu wypelnionych pism. Tu sa tylko czyste wzory."],
      children: [
        folderChild("Pisma", "Czyste wzory korespondencji."),
        folderChild("Decyzje", "Czyste wzory decyzji i pouczen."),
        folderChild("Formularze", "Czyste formularze do wypelnienia."),
        folderChild("Procedury", "Zatwierdzone i robocze wzory procedur."),
        folderChild("Logotypy_stopki_papier_firmowy", "Pliki graficzne i szablony wizualne szkoly."),
        folderChild("Archiwalne_wersje_szablonow", "Wycofane wersje wzorow, gdy trzeba zachowac slad zmiany."),
      ],
    },
    {
      id: "komunikaty",
      ...
      keep: ["Komunikaty do publikacji, wersje na strone, BIP, dla rodzicow i do mediow spolecznosciowych.", "Potwierdzenia publikacji i finalne PDF-y."],
      naming: ["2026-09-01_KOM_rozpoczecie-roku_strona_ZATWIERDZONE.docx", "2026-09-02_KOM_zebrania-z-rodzicami_VULCAN_WYSLANE.pdf"],
      avoid: ["Nie publikowac z folderu Do_publikacji, dopoki dokument nie ma statusu zatwierdzonego."],
      children: [
        folderChild("Do_publikacji", "Materialy gotowe do ostatniej kontroli i publikacji."),
        folderChild("Strona_internetowa", "Tresci i zalaczniki na strone szkoly."),
        folderChild("BIP", "Dokumenty przeznaczone do BIP i potwierdzenia publikacji."),
        folderChild("Rodzice_uczniowie", "Komunikaty dla rodzicow i uczniow, w tym VULCAN."),
        folderChild("Media_spolecznosciowe", "Posty, grafiki, skrocone komunikaty."),
      ],
    },
    {
      id: "archiwum",
      ...
      keep: ["Zamkniete kopie roboczych struktur rocznych.", "Materialy przygotowane do przekazania zgodnie z instrukcja archiwalna."],
      naming: ["Foldery roczne: 2024_2025, 2025_2026, 2026_2027."],
      avoid: ["Nie brakowac dokumentow tylko dlatego, ze sa w archiwum roboczym."],
      children: [
        folderChild("2024_2025", "Zamkniety rocznik pomocniczy."),
        folderChild("2025_2026", "Zamkniety rocznik pomocniczy."),
        folderChild("2026_2027", "Biezacy rocznik przenoszony po zamknieciu spraw."),
      ],
    },
    {
      id: "inbox",
      ...
      keep: ["Dokumenty do skanowania, dekretacji, podpisu, wyslania, publikacji lub uzupelnienia.", "Pliki powinny szybko przechodzic do wlasciwego obszaru."],
      naming: ["2026-09-12_INBOX_pismo-od-rodzica_2A_DO_DEKRETACJI.pdf", "2026-09-13_INBOX_odpowiedz-do-urzedu_DO_PODPISU.docx"],
      avoid: ["Nie przechowywac tu spraw stale. Folder nalezy czyscic regularnie."],
      children: [
        folderChild("Do_dekretacji", "Nie wiadomo jeszcze, kto prowadzi sprawe albo jaki ma byc tryb."),
        folderChild("Do_skanowania", "Dokument papierowy czeka na utrwalenie w PDF."),
        folderChild("Do_podpisu", "Dokument przygotowany do podpisu."),
        folderChild("Do_wyslania", "Dokument podpisany, oczekujacy na wysylke."),
        folderChild("Do_publikacji", "Material zatwierdzony albo prawie gotowy do publikacji."),
        folderChild("Do_uzupelnienia", "Brakuje danych, zalacznika, podpisu albo opisu."),
      ],
    },
  ],
};

const kancelariaQuickRoutes = [
...
function kancelariaPage() {
  return shell({
    title: "Instrukcja kancelarii | Procedury Szkoły Mistrzów",
    description: "Interaktywna mapa folderow kancelarii ZSZ nr 5 oraz zasady opisywania dokumentow w OneDrive.",
    body: `<main class="kancelaria-page">
      ${topbar("./", "kancelaria")}
      <section class="kancelaria-hero">
        <div>
          <p class="kancelaria-kicker">Foldery dla ludzi, klasyfikacja w ewidencji</p>
          <h1>Kancelaria ZSZ nr 5: jak odkładać, opisywać i odnajdywać dokumenty</h1>
          <p class="kancelaria-lead">Prosty układ folderów dla dyrekcji, sekretariatów, PPP, wychowawców oraz zespołów. Wejdź w folder, zobacz kto z niego korzysta, jakie pliki tam trzymać i jak je nazwać.</p>
          <div class="kancelaria-actions">
            <a href="#mapa-folderow">Otwórz mapę folderów</a>
            <a href="#opisywanie">Zasady opisu plików</a>
          </div>
        </div>
        <aside class="kancelaria-rulebox" aria-label="Trzy zasady kancelarii">
      ...
      <section class="folder-explorer" id="mapa-folderow">
        <div class="folder-copy">
          <h2>Wejdź w strukturę</h2>
          <p>Kliknij folder po lewej. Lista pod spodem pokaże kolejny poziom, a opis po prawej wyjaśni przeznaczenie, dostęp i przykłady nazw dokumentów.</p>
          <div class="breadcrumb" aria-label="Aktualna ścieżka" data-kancelaria-breadcrumb></div>
        </div>

        <div class="folder-stage">
          <div class="folder-layers" aria-label="Mapa folderów">
            <div class="folder-column" data-kancelaria-root></div>
            <div class="folder-column folder-column-next">
              <div class="folder-column-title" data-kancelaria-current></div>
              <div data-kancelaria-children></div>
            </div>
          </div>
          <article class="folder-detail" data-kancelaria-detail></article>
        </div>
      </section>

      <section class="instruction-section" id="opisywanie">
        <div class="instruction-main">
          <h2>Opis dokumentu ma mieć cztery warstwy</h2>
          <p>Sama nazwa folderu nie wystarczy. Dokument powinien być zrozumiały dla osoby, która otworzy go za pół roku: po nazwie pliku, po wpisie w ewidencji i po krótkiej karcie sprawy, jeśli sprawa ma kilka dokumentów.</p>
        </div>
        <div class="description-steps">
          <article><span>1</span><h3>Nazwa pliku</h3><code>YYYY-MM-DD_OBSZAR_krotki-temat_kogo-dotyczy_STATUS.pdf</code><p>Przykład: <code>2026-09-12_PPP_wniosek_2A_uczen-014_PRZYJETE.pdf</code>.</p></article>
          <article><span>2</span><h3>Wpis w ewidencji</h3><p>Data, numer pisma, prosty tytuł, osoba odpowiedzialna, status, termin i lokalizacja pliku.</p></article>
          <article><span>3</span><h3>Opis krótki</h3><p>Jedno zdanie: czego dotyczy dokument i jaka czynność ma z niego wynikać.</p></article>
          <article><span>4</span><h3>Karta sprawy</h3><p>Dla większej sprawy dodaj <code>00_KARTA_SPRAWY.md</code> z listą dokumentów, decyzji, terminów i uwag.</p></article>
        </div>
      </section>
      ...
      <section class="examples-section">
        <div>
          ...
          <p>Jeżeli folder działa jako biblioteka dokumentów, warto dodać kolumny. Komentarze mogą służyć do rozmowy bieżącej, ale stały opis powinien być w polach obok pliku.</p>
        </div>
        <div class="metadata-table" role="table" aria-label="Proponowane pola opisu pliku">
          ${[
          ...
          ].map(([label, value]) => `<div role="row"><strong role="cell">${esc(label)}</strong><span role="cell">${esc(value)}</span></div>`).join("")}
        </div>
      </section>

      <section class="routes-section">
        <div class="section-heading"><p>Szybkie decyzje</p><h2>Gdzie odłożyć typową sprawę</h2></div>
        <div class="route-list">
          ${kancelariaQuickRoutes.map(([question, answer]) => `<article><span>${esc(question)}</span><strong>${esc(answer)}</strong></article>`).join("")}
        </div>
      </section>
      ...
      <script id="kancelaria-data" type="application/json">${JSON.stringify(kancelariaTree).replaceAll("<", "\\u003c")}</script>
      <script>
      (() => {
        const tree = JSON.parse(document.getElementById("kancelaria-data").textContent);
        const entries = [];
        ...
        const list = (title, items) => "<section><h4>" + escHtml(title) + "</h4><ul>" + items.map((item) => "<li>" + escHtml(item) + "</li>").join("") + "</ul></section>";
        walk(tree);
        let selectedId = "root";
        const byId = (id) => entries.find((entry) => entry.node.id === id) || entries[0];
        const renderButton = (node, label, active) => "<button class=\\"folder-item" + (active ? " active" : "") + "\\" type=\\"button\\" data-folder-id=\\"" + escHtml(node.id) + "\\"><span>" + escHtml(label) + "</span><strong>" + escHtml(node.name) + "</strong></button>";
        const render = () => {
          const selected = byId(selectedId);
          const path = selected.parents.concat(selected.node);
          const children = selected.node.children || [];
          document.querySelector("[data-kancelaria-breadcrumb]").innerHTML = path.map((item, index) => "<button type=\\"button\\" data-folder-id=\\"" + escHtml(item.id) + "\\">" + (index ? "/ " : "") + escHtml(item.name) + "</button>").join("");
          document.querySelector("[data-kancelaria-root]").innerHTML = renderButton(tree, "Katalog", selected.node.id === "root") + (tree.children || []).map((item) => renderButton(item, item.name.slice(0, 2), path.some((pathItem) => pathItem.id === item.id))).join("");
          document.querySelector("[data-kancelaria-current]").textContent = selected.node.name;
          document.querySelector("[data-kancelaria-children]").innerHTML = children.length ? children.map((item) => renderButton(item, "podfolder", false)).join("") : "<p class=\\"folder-empty\\">Ten poziom nie ma dalszych podfolderów w strukturze startowej.</p>";
          document.querySelector("[data-kancelaria-detail]").innerHTML = "<span class=\\"folder-path\\">" + escHtml(path.map((item) => item.name).join(" / ")) + "</span><h3>" + escHtml(selected.node.title) + "</h3><dl><div><dt>Dla kogo</dt><dd>" + escHtml(selected.node.audience) + "</dd></div><div><dt>Dostęp</dt><dd>" + escHtml(selected.node.access) + "</dd></div></dl><div class=\\"folder-detail-grid\\">" + list("Co wkładać", selected.node.keep || []) + list("Jak opisywać", selected.node.naming || []) + list("Czego nie robić", selected.node.avoid || []) + "</div>";
        };
        document.addEventListener("click", (event) => {
          const button = event.target.closest("[data-folder-id]");
          if (!button) return;
          selectedId = button.dataset.folderId;
          render();
        });
        render();
      })();
    ...
    <section class="hero" id="start">
        <div class="hero-copy">
          ...
          <div class="hero-actions">
            ...
            <a class="secondary-action" href="./kancelaria.html">Instrukcja kancelarii</a>
...
fs.writeFileSync(path.join(outputDir, "kancelaria.html"), kancelariaPage());
